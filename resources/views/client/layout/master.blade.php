...
<head>
    ...
    <title>Nơi mua và thuê sách hàng đầu Việt Nam</title>
    <base />
    ...
    <link href="{{asset('client/css/fonts.googleapis.com/css-font-sans-serif.css')}}?family=Open Sans:400,700" rel="stylesheet">
    <link href="{{asset('client/css/fonts.googleapis.com/css-font-sans-serif.css')}}?family=Open Sans:400,700" rel="stylesheet">
